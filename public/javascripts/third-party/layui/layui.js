...
! function(win) {
    ...
    LAY.fn.use = function(apps, callback, exports) {
        ...
        var node = doc.createElement('script'),
            url = (gather.modules[item] ? (dir + 'lay/') : (config.base || '')) + (that.modules[item] || item) + '.js';
        node.async = true;
        node.src = url + "?v=" + function() {
            return config.version === true ? (config.v || (new Date()).getTime()) : (config.version || '');
        }();
        ...
        function onCallback() {
            ...
            apps.length > 1 ?
                that.use(apps.slice(1), callback, exports) : (typeof callback === 'function' && callback.apply(layui, exports));
        }
        ...
        terminal: {
            ...
            pc: {
                ...
                layim: 'pc/modules/layim' //web通讯
                    ,
                jinim: 'pc/modules/jinim' //web通讯  水木资本圈主管理端 wujq  2016-8-17
                    ,
